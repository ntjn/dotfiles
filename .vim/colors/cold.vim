" fork of 'lightning.vim' -- Vim color scheme.
...
if ($TERM =~ '256' || &t_Co >= 256) || has('gui_running')
  ...
  hi Comment          ctermbg=NONE ctermfg=73   guibg=NONE    guifg=#808080 cterm=NONE           gui=NONE
  hi Conceal          ctermbg=NONE ctermfg=250  guibg=NONE    guifg=#bcbcbc cterm=NONE           gui=NONE
  hi Constant         ctermbg=NONE ctermfg=52   guibg=NONE    guifg=#ff8700 cterm=NONE           gui=NONE
  hi Error            ctermbg=160  ctermfg=255  guibg=#d70000 guifg=#ffffff cterm=bold           gui=bold
  hi Identifier       ctermbg=NONE ctermfg=17   guibg=NONE    guifg=#0000d7 cterm=NONE           gui=NONE
  hi Ignore           ctermbg=NONE ctermfg=NONE guibg=NONE    guifg=NONE    cterm=NONE           gui=NONE
  hi PreProc          ctermbg=NONE ctermfg=23   guibg=NONE    guifg=#008787 cterm=NONE           gui=NONE
  hi Special          ctermbg=NONE ctermfg=35   guibg=NONE    guifg=#00af5f cterm=NONE           gui=NONE
  hi Statement        ctermbg=NONE ctermfg=17   guibg=NONE    guifg=#5f87ff cterm=NONE           gui=NONE
  hi String           ctermbg=NONE ctermfg=53   guibg=NONE    guifg=#005f87 cterm=NONE           gui=NONE
  hi Todo             ctermbg=228  ctermfg=234  guibg=#ffff87 guifg=#1c1c1c cterm=bold           gui=bold
  hi Type             ctermbg=NONE ctermfg=57   guibg=NONE    guifg=#870087 cterm=NONE           gui=NONE
  hi Underlined       ctermbg=NONE ctermfg=39   guibg=NONE    guifg=#00afff cterm=underline      gui=underline

  hi LineNr           ctermbg=NONE ctermfg=NONE guibg=#c6c6c6 guifg=#1c1c1c cterm=NONE           gui=NONE
  ...
  hi CursorLineNr     ctermbg=254  ctermfg=23   guibg=#e4e4e4 guifg=#5fafaf cterm=NONE           gui=NONE

  hi TabLineSel       ctermbg=NONE ctermfg=17   guibg=#afd7ff guifg=#444444 cterm=NONE           gui=NONE
  hi TabLineFill      ctermbg=NONE ctermfg=NONE guibg=#e4e4e4 guifg=#e4e4e4 cterm=NONE           gui=NONE
  hi TabLine          ctermbg=17   ctermfg=255  guibg=#ffffff guifg=#afd7ff cterm=NONE           gui=NONE
